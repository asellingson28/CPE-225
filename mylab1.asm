# CPE 225
# Lab 1
# Name: Arjan Ellingson
.data
Name: .string "Arjan" # Your name in double quotes
...
decval6:	.word -75  # 10110101b # 01001011 1+2+8+64
...
unsigned16bmax:	.word	65535  # Replace DDDDD with the maximum value that fits in 16bits. 2 hexadecimal digits is 8 bits, 4 hex is 16 bits. this means that 0xFFFF or 1111111111111111b
...
CarryNoOV1:	.word	200  # Replace DDD with a decimal value.
CarryNoOV2:	.word	100  # Replace DDD with a decimal value. # 300 > 256
...
SignNoCarry2:	.word	85  # Replace DDD with a decimal value. # results in 185 (greater than 127 but less than 255)
